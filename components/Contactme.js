...
function Contactme() {
  ...
  return (
    <section id="contactsect" className="sectione flex gap-12 items-center justify-between mt-10  relative">
        ...
        {!isHidden && <div id="toast-warning" className="contacttoast absolute right-2 top-1/5 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
